...
public class QEQuitCommandExecutor implements CommandExecutor {

    private HashMap<UUID, Explorer> idExplorerMap;
    private static final String PERMISSION = "explore.time";

    public QEQuitCommandExecutor(QuickExplore plugin, HashMap<UUID, Explorer> idExplorerMap) {
        plugin.getCommand("qequit").setExecutor(this);
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        idExplorerMap.remove(explorer.getUniqueId());
        explorer.refund();
        return true;
    }
